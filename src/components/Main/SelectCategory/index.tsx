  ...
  return (
    <View style={styles.selectContainer}>
      <Pressable onPress={() => {}} style={{gap:10}}>
        ...
        <Texto weight="bold" style={{color: '#FFFFFF', alignSelf: 'center', fontSize: 16}}>Projetos</Texto>
      </Pressable>
      ...
      <Pressable onPress={() => {}} style={{gap:10}}>
        ...
        <Texto weight="bold" style={{color: '#FFFFFF', alignSelf: 'center', fontSize: 16}}>Empresas</Texto>
      </Pressable>
      ...
      <Pressable onPress={() => {}} style={{gap:10}}>
        ...
        <Texto weight="bold" style={{color: '#FFFFFF', alignSelf: 'center', fontSize: 16}}>Modelos</Texto>
      </Pressable>
